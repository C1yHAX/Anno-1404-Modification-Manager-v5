...
namespace AnnoModificationManager5.ModificationTypes.XmlModule.XMLModifiers
{
    ...
    public class AddModifier : IXMLModifier
    {
        ...
        public void Activate()
        {
            ...
            string __TagName = AnnoModificationManager5.ModificationTypes.Userdefined.XMLUserdefinedValue.Append(this.TagName, UserdefinedValues);
            string __Value = !string.IsNullOrEmpty(Value) ? AnnoModificationManager5.ModificationTypes.Userdefined.XMLUserdefinedValue.Append(Value, UserdefinedValues) : "";
        ...
        public bool ValiditateUserdefinedValueAppend()
        {
            ...
            string __Value = AnnoModificationManager5.ModificationTypes.Userdefined.XMLUserdefinedValue.Append(Value, UserdefinedValues);
            string Selector = AnnoModificationManager5.ModificationTypes.Userdefined.XMLUserdefinedValue.Append(this.Selector, UserdefinedValues);
            string DeSelector = AnnoModificationManager5.ModificationTypes.Userdefined.XMLUserdefinedValue.Append(this.DeSelector, UserdefinedValues);
