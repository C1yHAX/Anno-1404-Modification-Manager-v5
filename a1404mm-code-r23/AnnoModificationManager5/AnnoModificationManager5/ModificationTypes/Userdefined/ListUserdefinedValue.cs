...
namespace AnnoModificationManager5.ModificationTypes.Userdefined
{
    ...
    public class ListUserdefinedValue
    {
        public IListModifier Parent;
        ...
        public static string Append(string source, List<ListUserdefinedValue> values)
        {
            foreach (ListUserdefinedValue val in values)
            {
        ...
        public static List<ListUserdefinedValue> FromXml(XmlNode node, IListModifier parent)
        {
            List<ListUserdefinedValue> output = new List<ListUserdefinedValue>();
        ...
        public static XmlNode ToXml(List<ListUserdefinedValue> labels, XmlDocument doc)
        {
            XmlNode nd = doc.CreateNode(XmlNodeType.Element, "UserdefinedValues", null);
            foreach (ListUserdefinedValue lb in labels)
            {
