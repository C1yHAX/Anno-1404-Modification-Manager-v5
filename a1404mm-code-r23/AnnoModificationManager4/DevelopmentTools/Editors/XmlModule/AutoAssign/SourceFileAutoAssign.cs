...
namespace DevelopmentTools.Editors.XmlModule.AutoAssign
{
    public class SourceFileAutoAssign
    {
        ...
        public static void Load()
        {
            ...
            foreach (string i in Properties.Settings.Default.XmlModuleCreator_FilterSystem_AutoAssign.Split(';'))
            {
        ...
        public static void Save()
        {
            ...
            Properties.Settings.Default.XmlModuleCreator_FilterSystem_AutoAssign = list;
