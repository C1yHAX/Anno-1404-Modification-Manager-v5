...
using listm = AnnoModificationManager4.ModificationTypes.ListModule.ListModifiers;
...
namespace AnnoModificationManager4.ModificationTypes
{
    ...
    public class ModificationUtils
    {
        ...
        {
            if (Modifier is AnnoModificationManager4.ModificationTypes.XmlModule.XMLModifiers.AddModifier)
                return Xml_AddModifiers;
            if (Modifier is AnnoModificationManager4.ModificationTypes.XmlModule.XMLModifiers.RemoveModifier)
                return Xml_RemoveModifiers;
            if (Modifier is AnnoModificationManager4.ModificationTypes.XmlModule.XMLModifiers.EditModifier)
        ...
        public void Xml_NodeModifiers_AddValue(xmlm.IXMLModifier Modifier)
        {
            ...
            //{
            //    Selector += "/" +
            //        (Modifier as AnnoModificationManager4.ModificationTypes.XmlModule.XMLModifiers.RemoveModifier).TagName;
            //}
        ...
        {
            if (Modifier is AnnoModificationManager4.ModificationTypes.ListModule.ListModifiers.AddGroupModifier)
                return List_AddGroupModifiers;
            if (Modifier is AnnoModificationManager4.ModificationTypes.ListModule.ListModifiers.AddModifier)
                return List_AddModifiers;
            if (Modifier is AnnoModificationManager4.ModificationTypes.ListModule.ListModifiers.RemoveModifier)
                return List_RemoveModifiers;
            if (Modifier is AnnoModificationManager4.ModificationTypes.ListModule.ListModifiers.EditModifier)
